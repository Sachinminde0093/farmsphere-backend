...
import ImageFileService from "./file";
...
class FileController implements Controller {
    ...
    initialiseRoutes() {
        this.router.post(`${this.path}/generate-url`,this.getUrl);
        this.router.post(`${this.path}`,this.getSignedUrl);
        this.router.post(`${this.path}/save`,this.saveFile);
    }
